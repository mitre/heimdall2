...
describe('AwsConfigMapping revision selection', () => {
  it('Should default to Rev 4, so existing callers keep the tags they had', () => {
  ...
  it('Should return each revision its own controls for the same rule', () => {
  ...
  it('Should take a per-lookup revision override', () => {
  ...
  it('Should expose the selected revision through the public lookup fields', () => {
  ...
  it('Should carry both revisions for every rule in the table', () => {
  ...
  it('Should resolve every rule under both revisions, losing none to key collisions', () => {
