...
// fs.writeFileSync('libs/hdf_converters/converted_jsons/burpsJson.json', JSON.stringify(mapper.data));
// fs.writeFileSync('libs/hdf_converters/outputs/burpsuite.json', JSON.stringify(mapper.toHdf()));
...
// fs.writeFileSync('libs/hdf_converters/outputs/dbprotect.json', JSON.stringify(mapper.toHdf()))
...
// fs.writeFileSync('libs/hdf_converters/outputs/fortify.json', JSON.stringify(mapper.toHdf()))
...
// fs.writeFileSync('libs/hdf_converters/converted_jsons/netsparkerJson.json', JSON.stringify(mapper.data))
// fs.writeFileSync('libs/hdf_converters/outputs/netsparker.json', JSON.stringify(mapper.toHdf()))
...
// fs.writeFileSync('libs/hdf_converters/outputs/nikto.json', JSON.stringify(mapper.toHdf()))
...
// fs.writeFileSync('libs/hdf_converters/outputs/sarif.json', JSON.stringify(mapper.toHdf()))
...
// fs.writeFileSync('libs/hdf_converters/outputs/scoutsuite.json', JSON.stringify(mapper.toHdf()))
...
// if (Array.isArray(result)) {
//   result.forEach(element => {
//     fs.writeFileSync(`libs/hdf_converters/outputs/snyk-${_.get(element, 'platform.target_id')}.json`, JSON.stringify(element))
//   })
// } else {
//   fs.writeFileSync('libs/hdf_converters/outputs/snyk.json', JSON.stringify(result))
// }
