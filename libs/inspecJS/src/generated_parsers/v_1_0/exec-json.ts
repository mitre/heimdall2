...
const typeMap: any = {
  ...
  ExecJSONControl: o(
    [
      ...
      {json: 'desc', js: 'desc', typ: u(undefined, u(null, ''))},
      {
        json: 'descriptions',
        js: 'descriptions',
        typ: u(undefined, u(a(r('ControlDescription')), null))
      },
      {json: 'id', js: 'id', typ: ''},
      ...
      {json: 'title', js: 'title', typ: u(undefined, u(null, ''))},
      {
        json: 'waiver_data',
        js: 'waiver_data',
        typ: u(undefined, u(null, r('WaiverData')))
      }
    ],
    'any'
  ),
  ...
  ControlResult: o(
    [
      ...
      {json: 'start_time', js: 'start_time', typ: ''},
      {
        json: 'status',
        js: 'status',
        typ: u(undefined, u(r('ControlResultStatus'), null))
      }
    ],
    'any'
  ),
  ...
  WaiverData: o(
    [
      ...
      {
        json: 'skipped_due_to_waiver',
        js: 'skipped_due_to_waiver',
  ...
  ControlResultStatus: ['error', 'failed', 'passed', 'skipped']
};
