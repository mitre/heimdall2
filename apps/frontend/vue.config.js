...
module.exports = {
  ...
  css: {
    loaderOptions: {
      sass: { sassOptions: { silenceDeprecations: sassSilenceDeprecations } },
      scss: { sassOptions: { silenceDeprecations: sassSilenceDeprecations } },
    },
  },
  devServer: {
    ...
    port: Number.parseInt(process.env.HEIMDALL_FRONTEND_PORT || '8080', 10),
