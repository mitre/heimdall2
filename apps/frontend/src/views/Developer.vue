...
export default class Developer extends mixins(RouteMixin, ServerMixin) {
  /**
   * The current state of the treemap as modeled by the treemap.
   * Expecting that if a "deep" selection is not null, then its parent should also be not-null.
   */
  ...
  get is_result_view(): boolean {
    return this.current_route === 'developer';
  }
