...
export default class DatabaseReader extends mixins(ServerMixin, RouteMixin) {
  ...
  //evaluationsLoaded: IEvaluation[] = this.evaluationsFake;
  ...
  // @Watch('evaluationsLoaded')
  // onValueChanged() {
  //   this.evaluations = this.evaluationsLoaded;
  // }
  ...
  getEvaluations(params: IEvalPaginationParams) {
    EvaluationModule.getAllEvaluations(params)
  ...
  evaluationsFake: any[] = [
    {
      filename: 'file 1',
      groups: 'group 1',
      evaluationTags: 'tag 1',
      createdAt: '12/12/2005'
    },
    {
      filename: 'file 2',
      groups: 'group 1',
