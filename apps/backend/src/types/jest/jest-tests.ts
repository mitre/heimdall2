...
const mock9 = jest.fn(
  (a: number, _b: string, _c: {}, _iReallyDontCare: [], _makeItStop: boolean) =>
...
const createMockFromModule2: {a: 'b'} =
  jest.createMockFromModule<{a: 'b'}>('moduleName');
...
jest
  .spyOn(spiedPromiseTarget, 'resolvesString')
