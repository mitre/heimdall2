...
describe('Okta Authentication Logic', () => {
  ...
  async function handleCallback(req) {
    ...
    if (req.user?.email) {
      mockLogger.log(
        `Login completed successfully for user: ${req.user.email}`
      );
    }
  }
  ...
  describe('User validation', () => {
    ...
    it('should handle unverified email', async () => {
      ...
      await expect(validateUser(userinfo)).rejects.toThrow(
    ...
    it('should handle authentication service errors', async () => {
      ...
      mockAuthnService.validateOrCreateUser.mockRejectedValueOnce(
    ...
    it('should handle callback correctly', async () => {
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        expect.stringContaining(
          'Login callback received for user: test@example.com'
        )
      );
      ...
      expect(mockLogger.log).toHaveBeenCalledWith(
        expect.stringContaining(
          'Login completed successfully for user: test@example.com'
        )
      );
    });
